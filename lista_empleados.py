...
# In this code, we define two teams: the QA team and the development team. 
# Each team is represented as a list of strings, where each string is the name of an employee.
...
# Next, we iterate through each team in the `department` list using a for loop.