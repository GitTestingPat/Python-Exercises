...
# Define a string variable called team and assign it the value "equipo"
team = "equipo" 

# Concatenate the strings stored in text_hello and team, and store the result in the variable print_str
print_str = text_hello + team 
